...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "12.3.1"
  WORKING_DIRECTORY "/home/rustuser/projects/rust/from_github/candle/third_party/VkFFT/glslang-main"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("12.3.1" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/12.3.1")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"12.3.1\" is not present locally, and not "
